...
/* AE touch information for AF/AE Division Function in Galaxy-Camera M2 */
struct m9mo_ae_touch {
	unsigned int start:1;
	unsigned int lock:1;
	unsigned int touch:1;
...
#define M9MO_MON_TOUCH_AE_WINDOW_POSITION_X 0xA6
#define M9MO_MON_TOUCH_AE_WINDOW_POSITION_Y 0xA8
#define M9MO_MON_TOUCH_AE_WINDOW_WIDTH 0xAA
#define M9MO_MON_TOUCH_AE_WINDOW_HEIGHT 0xAC
#define M9MO_MON_TOUCH_AE_START 0xAE
...
#define M9MO_CAPPARM_CAC_EN			0x1C
