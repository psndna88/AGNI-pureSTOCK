/* arch/arm/mach-omap2/board-kona-temp.c
 *
...
static int kona_temp_ap_temp_show(struct device *dev,
...
static DEVICE_ATTR(ap_temp, S_IRUGO, kona_temp_ap_temp_show, NULL);

static int omap4_kona_temp_init(void)
{
...
late_initcall(omap4_kona_temp_init);
