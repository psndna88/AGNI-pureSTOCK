...
struct omap_volt_data omap34xx_vddmpu_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP3430_VDD_MPU_OPP1_UV, 0,
			OMAP343X_CONTROL_FUSE_OPP1_VDD1,
			0xf4, 0x0c, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP3430_VDD_MPU_OPP2_UV, 0,
			OMAP343X_CONTROL_FUSE_OPP2_VDD1,
			0xf4, 0x0c, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP3430_VDD_MPU_OPP3_UV, 0,
			OMAP343X_CONTROL_FUSE_OPP3_VDD1,
			0xf9, 0x18, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP3430_VDD_MPU_OPP4_UV, 0,
			OMAP343X_CONTROL_FUSE_OPP4_VDD1,
			0xf9, 0x18, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP3430_VDD_MPU_OPP5_UV, 0,
...
struct omap_volt_data omap34xx_vddcore_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP3430_VDD_CORE_OPP1_UV, 0,
			OMAP343X_CONTROL_FUSE_OPP1_VDD2,
			0xf4, 0x0c, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP3430_VDD_CORE_OPP2_UV, 0,
			OMAP343X_CONTROL_FUSE_OPP2_VDD2,
			0xf4, 0x0c, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP3430_VDD_CORE_OPP3_UV, 0,
...
struct omap_volt_data omap36xx_vddmpu_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP50_UV, 0,
			OMAP3630_CONTROL_FUSE_OPP50_VDD1,
			0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP100_UV, 0,
			OMAP3630_CONTROL_FUSE_OPP100_VDD1,
			0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP120_UV, 0,
...
struct omap_volt_data omap36xx_vddcore_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP3630_VDD_CORE_OPP50_UV, 0,
			OMAP3630_CONTROL_FUSE_OPP50_VDD2,
			0xf4, 0x0c, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP3630_VDD_CORE_OPP100_UV, 0,
