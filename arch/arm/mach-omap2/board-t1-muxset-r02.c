...
static struct omap_muxtbl muxtbl[] __initdata = {
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     OMAP_PIN_OFF_WAKEUPENABLE,
		     94, "EAR_SEND_END"),
	/* [-----] usbb1_ulpitll_dat7.dmtimer11_pwm_evt - MOTOR_PWM */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     USBB1_ULPITLL_DAT7,
		     OMAP_MUX_MODE1 | OMAP_PIN_OUTPUT | OMAP_PIN_OFF_OUTPUT_LOW,
		     95, "MOTOR_PWM"),
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     150, "WLAN_SD_D(3)"),
	/* [-----] mcspi4_clk.mcspi4_clk - LCD_SCLK */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     MCSPI4_CLK,
		     OMAP_MUX_MODE0 | OMAP_PIN_OUTPUT | OMAP_PIN_OFF_OUTPUT_LOW,
		     151, "LCD_SCLK"),
	/* [-----] mcspi4_simo.mcspi4_simo - LCD_SDI */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     MCSPI4_SIMO,
		     OMAP_MUX_MODE0 | OMAP_PIN_OUTPUT | OMAP_PIN_OFF_OUTPUT_LOW,
		     152, "LCD_SDI"),
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     USBB2_ULPITLL_STP,
		     OMAP_MUX_MODE5 | OMAP_PIN_OUTPUT | OMAP_PIN_OFF_OUTPUT_LOW,
		     158, "LCD_D(23)"),
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     OMAP_MUX_MODE5 | OMAP_PIN_OUTPUT | OMAP_PIN_OFF_OUTPUT_LOW,
		     168, "LCD_D(11)"),
	/* [IN---] usbb2_hsic_data.gpio_169 - OTG_OUT_5V */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     USBB2_HSIC_DATA, OMAP_MUX_MODE3 | OMAP_PIN_INPUT,
		     169, "OTG_OUT_5V"),
	/* [-N-C-] usbb2_hsic_strobe.safe_mode - NC */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     USBB2_HSIC_STROBE,
		     OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     178, "GPS_nRST"),
	/* [-----] kpd_row1.kpd_row1 - KBR(1) */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     KPD_ROW1,
		     OMAP_MUX_MODE0 | OMAP_PIN_INPUT |
		     OMAP_PIN_OFF_WAKEUPENABLE,
		     2, "KBR(1)"),
	/* [-----] kpd_row2.kpd_row2 - KBR(2) */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     KPD_ROW2,
		     OMAP_MUX_MODE0 | OMAP_PIN_INPUT |
		     OMAP_PIN_OFF_WAKEUPENABLE,
		     3, "KBR(2)"),
	/* [-----] usba0_otg_ce.usba0_otg_ce - USB_CHGEN */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     OMAP_MUX_MODE0 | OMAP_PIN_INPUT | OMAP_PIN_OFF_OUTPUT_LOW,
		     182, "VT_CAM_MCLK"),
	/* [-N-C-] fref_clk3_req.safe_mode - NC */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_WKUP,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_WKUP,
		     FREF_CLK4_OUT, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLDOWN,
		     8, "fref_clk4_out.nc"),
