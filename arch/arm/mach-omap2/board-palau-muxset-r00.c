/* arch/arm/mach-omap2/board-palau-muxset-r00.c
 *
...
static struct omap_muxtbl muxtbl[] __initdata = {
	...
	/* [-N-C-] gpmc_ad8.gpio_32 - NC */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     GPMC_AD8, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLDOWN,
		     32, "gpmc_ad8.nc"),
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     46, "TOUCH_nINT"),
	/* [--OUT] gpmc_a23.gpio_47 - SEL_AUX_MIC */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     53, "CP_ON"),
	/* [--OUT] gpmc_nwp.gpio_54 - IMA_PWR_EN */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     60, "gpmc_nbe1.nc"),
	/* [-N-C-] gpmc_wait0.gpio_61 - NC */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     GPMC_WAIT0, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLDOWN,
		     61, "gpmc_wait0.nc"),
	/* [-N-C-] gpmc_wait1.safe_mode - NC */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     GPMC_WAIT1, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN,
		     62, "gpmc_wait1.nc"),
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     GPMC_NCS4, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLDOWN,
		     101, "IMA_SLEEP"),
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     OMAP_MUX_MODE0 | OMAP_PIN_INPUT | OMAP_PIN_OFF_OUTPUT_LOW,
		     80, "VT_CAM_D0_N"),
	/* [--OUT] cam_shutter.gpio_81 - TORCH_FLASH_SET */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     CAM_SHUTTER, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT,
		     81, "TORCH_FLASH_SET"),
	/* [--OUT] cam_strobe.gpio_82 - TORCH_FLASH_EN */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     CAM_STROBE, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT,
		     82, "TORCH_FLASH_EN"),
	/* [--OUT] cam_globalreset.gpio_83 - IMA_CMC_EN */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     135, "ISP_RESET"),
	/* [--OUT] mcspi1_simo.gpio_136 - GPS_nRST */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
	...
	/* [IN---] usbb2_ulpitll_stp.gpio_158 - eMMC_EN */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     USBB2_ULPITLL_STP, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP,
		     158, "eMMC_EN"),
	...
	/* [--OUT] usbb2_ulpitll_nxt.gpio_160 - LCD_TE */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     USBB2_ULPITLL_NXT, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT,
		     160, "LCD_TE"),
	/* [--OUT] usbb2_ulpitll_dat0.gpio_161 - VUSB_EN */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     USBB2_ULPITLL_DAT0, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT,
		     161, "VUSB_EN"),
	/* [IN---] usbb2_ulpitll_dat1.gpio_162 - ISP_STANDBY */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     USBB2_ULPITLL_DAT5, OMAP_MUX_MODE4 | OMAP_PIN_OUTPUT,
		     166, "CAM_SPI_SSN"),
	/* [-----] usbb2_ulpitll_dat6.mcspi3_simo - CAM_SPI_MOSI */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     USBB2_ULPITLL_DAT6, OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLUP,
		     167, "CAM_SPI_MOSI"),
	/* [-----] usbb2_ulpitll_dat7.mcspi3_clk - CAM_SPI_SCLK */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     USBB2_ULPITLL_DAT7, OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLUP,
		     168, "CAM_SPI_SCLK"),
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     175, "kpd_row3.nc"),
	/* [IN---] kpd_row4.gpi_176 - MSENSE_INT */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     KPD_ROW4, OMAP_MUX_MODE3 | OMAP_PIN_INPUT,
		     176, "MSENSE_INT"),
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_WKUP,
		     ...
		     OMAP_PIN_OFF_WAKEUPENABLE,
		     30, "VOL_UP"),
	/* [-N-C-] fref_clk3_out.safe_mode - NC */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_WKUP,
		     FREF_CLK3_OUT, OMAP_MUX_MODE7 | OMAP_PIN_INPUT_PULLDOWN,
		     31, "fref_clk3_out.nc"),
	/* [--OUT] fref_clk4_req.gpio_wk7 - SUBPM_EN */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_WKUP,
	...
	/* [IN---] sys_nirq2.gpio_183 - BARO_INT */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     SYS_NIRQ2,
		     OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP |
		     OMAP_PIN_OFF_INPUT_PULLDOWN,
	...
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     ...
		     15, "CP_PMU_RST"),
	/* [IN---] dpm_emu5.gpio_16 - OLED_ID */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     DPM_EMU5, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLDOWN,
		     16, "OLED_ID"),
	/* [IN---] dpm_emu6.gpio_17 - NFC_IRQ */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     DPM_EMU6,
		     OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP |
		     OMAP_PIN_OFF_WAKEUPENABLE,
		     17, "NFC_IRQ"),
	/* [--OUT] dpm_emu7.gpio_18 - LCD_3.3V_EN */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     DPM_EMU7, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT,
		     18, "LCD_3.3V_EN"),
	/* [--OUT] dpm_emu8.gpio_19 - TOUCH_EN */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     DPM_EMU8, OMAP_MUX_MODE3 | OMAP_PIN_OUTPUT,
		     19, "TOUCH_EN"),
	/* [IN---] dpm_emu9.gpio_20 - IMA_INT */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     DPM_EMU9, OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP,
		     20, "IMA_INT"),
	/* [IN---] dpm_emu10.gpio_21 - PS_ALS_INT */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
		     DPM_EMU10,
		     OMAP_MUX_MODE3 | OMAP_PIN_INPUT_PULLUP |
		     OMAP_PIN_OFF_WAKEUPENABLE,
		     21, "PS_ALS_INT"),
	/* [--OUT] dpm_emu11.gpio_22 - LCD_1.8V_EN */
	OMAP4_MUXTBL(OMAP4_MUXTBL_DOMAIN_CORE,
...
add_sec_muxtbl_to_list(SEC_MACHINE_PALAU, 0, muxtbl);
