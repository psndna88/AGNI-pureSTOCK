/* arch/arm/mach-omap2/board-palau-audio.c
 *
...
static struct i2c_board_info palau_audio_i2c1_board_info[] __initdata = {
	{
...
void __init omap4_palau_audio_init(void)
{
	...
	wm1811_pdata.mclk_pin =
		omap_muxtbl_get_gpio_by_name("CODEC_CLK_REQ");
	gpio_request(wm1811_pdata.mclk_pin, "CODEC_CLK_REQ");
	...
	palau_audio_i2c1_board_info[0].irq = gpio_to_irq(gpio_ear_send_end);

	i2c_register_board_info(1, palau_audio_i2c1_board_info,
				ARRAY_SIZE(palau_audio_i2c1_board_info));
}
